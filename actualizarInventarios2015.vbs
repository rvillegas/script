...
Set cnn=CreateObject("ADODB.Connection")
	cnn.Open conexion
    Archivo="D:\datos\csv\inventario" & Month(Now)& ".sql.csv"
...
For i=1 To 2
	...
	Archivo="D:\datos\csv\inventario" & right("00" & i,2) & ".sql.csv"
	Set fso= CreateObject("Scripting.FileSystemObject")
	If Not fso.FileExists(Archivo) Then 
		MsgBox "No exite el archivo " & Archivo
		'WScript.Quit
    ...
    sql="delete  from inventarios where ano=2015 and mes=" & i
	cnn.Execute(sql)
