...
WHERE (referencias_sto.ano=@@1) AND (referencias_sto.mes=@@2) 
      and ( referencias_sto.can_ini+ referencias_sto.can_ent+ referencias_sto.can_sal
	+ referencias_sto.can_com+ referencias_sto.can_dev_com+ referencias_sto.can_otr_ent
	+ referencias_sto.can_otr_sal+ referencias_sto.can_tra+ referencias_sto.cos_tra>0)
